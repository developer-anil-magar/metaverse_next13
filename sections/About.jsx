  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        is a new thing in the future, where you can enjoy the virtual world by feeling like it's really real, you can feel in thid metaverse world, because this is really the
        <span className="font-extrabold text-white"> madness of the metaverse explore </span>
        of today, using only
